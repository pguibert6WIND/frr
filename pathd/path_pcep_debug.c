...
static void
_format_pcep_object_tlv_srv6_pce_capability(int ps,
				     ...
				     struct pcep_object_tlv_header *tlv_header)
{
	...
	case PCEP_OBJ_TLV_TYPE_SR_PCE_CAPABILITY:
		...
		break;
	case PCEP_OBJ_TLV_TYPE_SRV6_PCE_CAPABILITY:
		_format_pcep_object_tlv_srv6_pce_capability(ps,
...
void _format_pcep_object_tlv_srv6_pce_capability(int ps,
						 struct pcep_object_tlv_srv6_pce_capability *tlv)
{
	PATHD_FORMAT("%*sflag_n: %u\n", ps, "", tlv->flag_n);
