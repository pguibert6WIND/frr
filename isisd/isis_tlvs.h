...
enum isis_tlv_type {
	...
	/* RFC 9352 section #4.1 */
	ISIS_SUBTLV_SRV6_MAX_SL_MSD = SRV6_MSD_TYPE_SEGS_LEFT,
	/* RFC 9352 section #4.2 */
	ISIS_SUBTLV_SRV6_MAX_END_POP_MSD = SRV6_MSD_TYPE_END_POP,
	/* RFC 9352 section #4.3 */
	ISIS_SUBTLV_SRV6_MAX_H_ENCAPS_MSD = SRV6_MSD_TYPE_H_ENCAPS,
	/* RFC 9352 section #4.4 */
	ISIS_SUBTLV_SRV6_MAX_END_D_MSD = SRV6_MSD_TYPE_END_D,
