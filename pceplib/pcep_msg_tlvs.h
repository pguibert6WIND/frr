...
enum pcep_object_tlv_types {
	...
	PCEP_OBJ_TLV_TYPE_SRV6_PCE_CAPABILITY = 27,	/* RFC 9603 */
...
pcep_tlv_create_sr_pce_capability(bool flag_n, bool flag_x,
				  uint8_t max_sid_depth);
struct pcep_object_tlv_srv6_pce_capability *
pcep_tlv_create_srv6_pce_capability(bool flag_n, uint8_t max_end_d, uint8_t max_end_pop,
