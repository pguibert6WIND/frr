...
DEFINE_MTYPE(BGPD, BGP_DAMP_CONFIG, "BGP peer dampening config");
...
DEFINE_MTYPE(BGPD, PEER_TCP_AO_KEY, "Peer TCP-AO key");
DEFINE_MTYPE(BGPD, BGP_TCP_AO_PROFILE, "BGP TCP-AO profile");
...
DEFINE_MTYPE(BGPD, ATTR_EXTRA, "BGP attribute extra");
