...
#define BGP_NHG_STATE_UPDATED	(1 << 2)
	 ...
	 * bgp_nhg(3)->nhg_child_groups has 1 and 2 in the tree
	 * bgp_nhg(3)->nhg_parent_groups is empty
	 *
	 * bgp_nhg(1)->nhg_child_groups is empty
	 * bgp_nhg(1)->nhg_parent_groups is 3 in the tree
	 *
	 * bgp_nhg(2)->nhg_child_groups is empty
	 * bgp_nhg(2)->nhg_parent_groups is 3 in the tree
	 */
